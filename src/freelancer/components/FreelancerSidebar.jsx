...
function FreelancerSidebar({ setDisplayPanel }) {
    ...
    >
      ...
      <div className="flex flex-col items-center mb-10">
        <div className="relative">
          ...
          <img src="/bmc.png" alt="Profile" className={`rounded-full border-4 border-white shadow-md transition-all duration-300 ${isOpen ? 'w-24 h-24' : 'w-12 h-12'}`} />
        </div>
        {isOpen && (
          <>
            <h1 className="text-lg font-semibold mt-3 text-gray-50">{loggedUser?.freelancerName}</h1>
